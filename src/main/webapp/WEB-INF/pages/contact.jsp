	...
	<div class="page">
		<div style="max-width: 760px; margin: 0 auto;">
			...
			<div class="page-header">
				<h1>Contact Us</h1>
				<p>We&#x2019;d love to hear from you. Send us a message and
			...
			<div class="info-grid">
				...
				<div class="card center">
					<div class="info-icon"></div>
					<img src="${ctx}/images/mail.png" alt="Cart" width="30" height="30">
					<h3>Email</h3>
					<p>support@ecosprout.com.np</p>
				</div>
				<div class="card center">
					<div class="info-icon"></div>
					<img src="${ctx}/images/clock.png" alt="Cart" width="30" height="30">
					<h3>Hours</h3>
