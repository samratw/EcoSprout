...
<nav class="navbar">
    ...
    <c:choose>
        <c:when test="${role eq 'admin'}">
            <a href="${ctx}/admin" class="brand-link">
                <img src="${ctx}/images/logo.png" width="220" height="58" alt="EcoSprout">
            </a>
        </c:when>
        <c:when test="${role eq 'vendor'}">
            <a href="${ctx}/vendor" class="brand-link">
                <img src="${ctx}/images/logo.png" width="220" height="58" alt="EcoSprout">
            </a>
        </c:when>
        <c:when test="${role eq 'buyer'}">
            <a href="${ctx}/buyer" class="brand-link">
                <img src="${ctx}/images/logo.png" width="220" height="58" alt="EcoSprout">
            </a>
        </c:when>
        <c:otherwise>
            <a href="${ctx}/" class="brand-link">
                <img src="${ctx}/images/logo.png" width="220" height="58" alt="EcoSprout">
            </a>
        </c:otherwise>
    </c:choose>
