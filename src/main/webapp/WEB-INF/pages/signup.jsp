    ...
    <div class="signup-left">
    	<div class="signup-brand">ECOSPROUT</div>
      	<div class="signup-box">
        	...
        	<form action="<%=request.getContextPath()%>/signuppage" method="post">
          		...
          		<div class="form-group">
            		...
            		<input type="password" name="rePassword" placeholder="Re-type your password" required>
          		</div>
          		<button type="submit" class="signup-btn-submit">Create Account</button>
        	</form>
